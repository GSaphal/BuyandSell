...
export default class RealEstateGrid extends Component {
  ...
  searchingApi = (data) => {
    ...
    Axios.post(
      process.env.REACT_APP_API + "realestates/search",
      typeof data === "object"
        ? {
  ...
  handleSearchSubmit = (e) => {
    ...
    Axios.post(process.env.REACT_APP_API + "realestatesearching", {
      search: this.state.search,
    })
      .then((response) => {
        this.setState({
  ...
  handleSubmit = (event) => {
    ...
    Axios.post(process.env.REACT_APP_API + "realestates/search", submitData)
              ...
              <div className="col col-lg-12 col-xl-10">
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item">
                      <Link to="/vehicle/list">Realestate</Link>
                    </li>
                  </ol>
                </nav>
