...
export default class Vehicle extends Component {
  ...
  searchingApi = data => {
    ...
    Axios.post(
      process.env.REACT_APP_API + "vehicles/filter",
      typeof data === "object"
        ? {
  ...
  handleSearchSubmit = e => {
    ...
    Axios.post(process.env.REACT_APP_API + "vehicles/search", {
      search: this.state.search
    })
      .then(response => {
        this.setState({
  ...
  handleSubmit = event => {
    ...
    Axios.post(process.env.REACT_APP_API + "vehicles/filter", submitData)
              ...
              <div className="col col-lg-12 col-xl-10">
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item">
                      <Link href="/vehicle/list">Vehicle</Link>
                    </li>
                  </ol>
                </nav>
